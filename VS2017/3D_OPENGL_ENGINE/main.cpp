...
const int DELAY_TIME = (int)1000.0f / FPS;	//How many ticks must elapse before next frame

int main(int argc, char* args[]) {

	Uint32 frameStart, frameTime;	//Variables for framerate limit

	Game::instance()->init("ACCESS", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, 16.0/9.0, false);
